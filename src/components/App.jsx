    ...
    this.state = {
      ...
      technicalInterestList: {
        catigories: {
          ...
          notes: [
            'I find myself growing interested in how sites categorize information of their site and how that may inform users as to their non-conscience interests.'
          ]
        }
      },
  ...
  render(){
    return (
      ...
      <div>
        <Header/>
        <switch>
          <Route exact path='/education' render={()=><EducationList educationList={this.state.educationList}/>}/>
        </switch>
      </div>
